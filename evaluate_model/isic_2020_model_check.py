...
def isic_2020_data_preprocess():
    ...
    a.data_separation(data_list=benign_list, source=raw_dir_path,
                      destination=processed_dir_path + "benign/",
                      extension="ben")
    a.data_separation(data_list=malignant_list, source=raw_dir_path,
                      destination=processed_dir_path + "malignant/",
                      extension="mal")
...
def isic_2020_train_model():
    feats = np.load("data/isic_2020/processed_data/feats_train.npy")
    labels = np.load("data/isic_2020/processed_data/labels_train.npy")
    print("loading done")
